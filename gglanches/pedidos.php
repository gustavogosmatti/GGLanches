 ...
 */
    ...
    class pedidosPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new NumberViewColumn('idcliente', 'idcliente', 'Idcliente', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            // View column for idfuncionario field
            //
            $column = new NumberViewColumn('idfuncionario', 'idfuncionario', 'Idfuncionario', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('idcliente_edit');
            $editColumn = new CustomEditColumn('Idcliente', 'idcliente', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            $editor = new TextEdit('idfuncionario_edit');
            $editColumn = new CustomEditColumn('Idfuncionario', 'idfuncionario', $editor, $this->dataset);
